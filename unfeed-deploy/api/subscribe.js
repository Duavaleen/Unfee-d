...
export default async function handler(req, res) {
    ...
    if (!apiKey || !publicationId) {
        console.error('Missing Beehiiv credentials. Please set BEEHIIV_API_KEY and BEEHIIV_PUBLICATION_ID environment variables.');
    ...
    try {
        ...
        const subscribeResponse = await fetch(`https://api.beehiiv.com/v2/publications/${publicationId}/subscriptions`, {
            ...
            body: JSON.stringify({
                ...
                utm_source: 'unfeed-calculator',
                utm_medium: 'web',
                utm_campaign: 'fee-calculator',
                custom_fields: data ? {
                    monthly_revenue: data.monthlyRevenue || '',
                    platforms: data.platforms || '',
                    annual_fees: data.annualFees || '',
